...
printf("\nNNMD                                                                          \n"         
    ...
    printf("\n                 {<Correções e Arte feita por Paulo Archanjo>} \n \t\t _____________________________________________\n\n\t\t  I Pressione qualquer tecla para continuar I\n");
    
  getch();
   system("cls");
   system("color 0F");
   printf("\t\t\t\t <<Instruções>>\n________________________________________________________________________________\n");
   printf("\n-> Use as setas para mover a cobra.\n\n-> Você receberá alimentos nas várias coordenadas da tela que você deve comer.\nToda vez que você come um alimento, o comprimento da cobra aumenta em 1 elemento\ne, portanto, a pontuação.\n\n-> Aqui você receberá três vidas. Sua vida diminuirá quando voce bater na parede\nou no corpo da cobra.\n\n-> Você pode pausar o jogo no meio pressionando qualquer tecla. Para continuar o\njogo pausado, pressione qualquer outra tecla mais uma vez. \n\n-> Se você quiser sair, pressione ESC.\n\n-> Quando o Loading terminar, Pressione ENTER\n");
